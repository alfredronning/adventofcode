...
def printboard(points):
    maxx, minx = max(point[0] for point in points), min(point[0] for point in points)
    maxy, miny = max(point[1] for point in points), min(point[1] for point in points)
...
if __name__ == "__main__":
    ...
    for folding_y, index in instructions:
