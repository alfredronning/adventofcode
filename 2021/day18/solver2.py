...
if __name__ == "__main__":
    ...
    highest = 0
    for snailfish_node in snailfish:
        for snailfish_node2 in snailfish:
            if snailfish_node == snailfish_node2:
                continue
            highest = max(highest, calc_snailfish([deepcopy(snailfish_node), deepcopy(snailfish_node2)]))
            highest = max(highest, calc_snailfish([deepcopy(snailfish_node2), deepcopy(snailfish_node)]))
    print(highest)
